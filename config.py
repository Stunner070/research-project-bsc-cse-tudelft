...
RETRIEVAL_OUTPUT_DIR     = PROJECT_ROOT / "retrieval_results_resolution_640_10frames"  # Folder to write the comparison JSON (independent of either work dir)
...
# ─── Evaluation Run ──────────────────────────────────────────────────────────
RETRIEVAL_RUN_NAME             = "resolution_640_10frames"                       # Name used to export the CSV file with raw metrics
