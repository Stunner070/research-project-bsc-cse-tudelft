...
RETRIEVAL_V2E_ROOT_B = Path("/scratch/sofyanali/voxceleb/dev/on_symmetry")
# RETRIEVAL_WORK_DIR_B     = Path("C:/Users/sofya/Desktop/event_videos/voxceleb/output_leak_5")  # Derived-output root for adjusted
RETRIEVAL_WORK_DIR_B = Path("/scratch/sofyanali/voxceleb/dev/output_on_symmetry")  # Derived-output root for adjusted
...
RETRIEVAL_OUTPUT_DIR     = PROJECT_ROOT / "retrieval_results_on_symmetry_300clips"  # Folder to write the comparison JSON (independent of either work dir)
...
# ─── Evaluation Run ──────────────────────────────────────────────────────────
RETRIEVAL_RUN_NAME             = "on_symmetry_300clips"                       # Name used to export the CSV file with raw metrics
